...
class _ProductApiService implements ProductApiService {
  ...
  Future<HttpResponse<PageResponse<Product>>> getProducts(
    ...
    final _options = _setStreamType<HttpResponse<PageResponse<Product>>>(
    ...
    late PageResponse<Product> _value;
    try {
      _value = PageResponse<Product>.fromJson(
        _result.data!,
  ...
  @override
  Future<List<ProductSearchResult>> searchProductsByName(String name) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'name': name};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<ProductSearchResult>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    late List<ProductSearchResult> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                ProductSearchResult.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
