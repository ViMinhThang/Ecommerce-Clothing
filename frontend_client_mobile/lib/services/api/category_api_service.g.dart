...
class _CategoryApiService implements CategoryApiService {
  ...
  @override
  Future<List<CategorySearchResult>> searchCategoriesByName(String name) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'name': name};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<CategorySearchResult>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<CategorySearchResult> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                CategorySearchResult.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
