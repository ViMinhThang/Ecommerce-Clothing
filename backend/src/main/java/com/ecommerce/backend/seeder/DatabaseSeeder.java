...
public class DatabaseSeeder implements CommandLineRunner {
        ...
        private void seedProducts(User admin, Map<String, Category> categoryMap, Map<String, Color> colorMap,
                ...
                createVariants(p, List.of("Black", "Red", "Brown"), 89.95, 69.99, colorMap, sizeMap, materialMap,
                                seasonMap);
                ...
                createVariants(p, List.of("Black", "Grey", "Navy", "White"), 69.95, 55, colorMap, sizeMap, materialMap,
                                seasonMap);
                ...
                createVariants(p, List.of("Brown", "Beige", "Black"), 228, 114, colorMap, sizeMap, materialMap,
                                seasonMap);
                ...
                /*
                 * New Products: giữ 1 lần duy nhất theo name:
                ...
                createVariants(p, List.of("White", "Blue", "Grey", "Pink", "Brown", "Black", "Navy", "Beige", "Yellow",
                                "Red"), 59.95, 35, colorMap, sizeMap, materialMap, seasonMap);

                /*
                 * New Products: giữ 1 lần duy nhất theo name:
                 * "VintageSoft Wedge Crewneck Sweatshirt"
                 */
                ...
                createVariants(p, List.of("Brown", "Pink", "Blue", "Red", "Black", "Grey", "White", "Green"), 59.95, 29,
                ...
                createVariants(p, List.of("White", "Blue", "Grey", "Pink", "Brown", "Black", "Navy", "Beige", "Yellow",
                                "Red"), 49.95, 24, colorMap, sizeMap, materialMap, seasonMap);
                ...
                createVariants(p, List.of("Brown", "Pink", "Blue", "Red", "Black", "Grey", "White", "Green"), 59.95, 35,
                                colorMap, sizeMap, materialMap, seasonMap);
                ...
                createVariants(p, List.of("White", "Blue", "Grey", "Pink", "Brown", "Black", "Navy", "Beige", "Yellow",
                                "Red"), 49.95, 39.99, colorMap, sizeMap, materialMap, seasonMap);
                ...
                createVariants(p, List.of("Custom", "Blue", "Olive", "Brown", "White"), 79.95, 47, colorMap, sizeMap,
                                materialMap, seasonMap);
                ...
                createVariants(p, List.of("White", "Blue", "Grey", "Pink", "Brown", "Black", "Navy", "Beige", "Yellow",
                                "Red"), 59.95, 47, colorMap, sizeMap, materialMap, seasonMap);
                ...
                createVariants(p, List.of("White", "Brown", "Pink", "Blue", "Grey", "Black", "Red"), 24.95, 22,
                                colorMap, sizeMap, materialMap, seasonMap);
                ...
                createVariants(p, List.of("White", "Custom", "Red", "Black"), 69.95, 34, colorMap, sizeMap, materialMap,
                                seasonMap);
                ...
                createVariants(p, List.of("Navy", "Black", "Green", "Blue", "White", "Pink"), 59.95, 35, colorMap,
                                sizeMap, materialMap, seasonMap);
                ...
                createVariants(p, List.of("White", "Blue", "Burgundy", "Black"), 69.95, 69.95, colorMap, sizeMap,
                                materialMap, seasonMap);
                ...
                createVariants(p, List.of("Blue", "White", "Navy", "Olive", "Pink", "Red", "Custom", "Black"), 59.95,
                                35, colorMap, sizeMap, materialMap, seasonMap);
                ...
                createVariants(p, List.of("Pink", "Blue", "Black", "Brown", "Grey", "White", "Yellow"), 59.95, 47,
                                colorMap, sizeMap, materialMap, seasonMap);
                ...
                createVariants(p, List.of("Custom", "Indigo", "Brown", "Black", "Red"), 89.95, 71, colorMap, sizeMap,
                                materialMap, seasonMap);
        }
}
