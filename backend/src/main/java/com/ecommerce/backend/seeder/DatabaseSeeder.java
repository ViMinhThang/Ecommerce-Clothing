...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        product1.setImageUrl("http://10.0.2.2:8080/uploads/3a3df57f-af6a-45c2-93c1-c4d3924616b6.jpg");
        Product product2 = new Product();
        product2.setName("The Lord of the Rings");
        product2.setDescription("A classic fantasy novel");
        product2.setCategory(category2);
        product2.setImageUrl("http://10.0.2.2:8080/uploads/3a3df57f-af6a-45c2-93c1-c4d3924616b6.jpg");
