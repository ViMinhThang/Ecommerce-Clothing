...
class _FiltersPageState extends State<FiltersPage> {
  ...
  final _seasons = ['Summer', 'Autumn', 'Winter', 'Spring'];
  final _materials = ['Viscose', 'Cotton', 'Denim', 'Linen'];
  ...
  final Set<String> _selectedMaterials = {'Cotton'};
  final Set<int> _selectedColorIdx = {0};
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        _PillValue(
                          label: 'from',
                          value: _minPrice.toInt().toString(),
                        ),
                        const SizedBox(width: 8),
                        _PillValue(
                          label: 'to',
                          value: _maxPrice.toInt().toString(),
                        ),
                        const Spacer(),
                      ],
                    ),
                        ...
                        Expanded(
                          child: Wrap(
                            ...
                            children: List.generate(_palette.length, (i) {
                              return _ColorDot(
                                color: _palette[i],
                                selected: _selectedColorIdx.contains(i),
                                onTap: () {
                                  setState(() {
